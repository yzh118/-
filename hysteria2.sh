...
inst_cert(){
    ...
    echo ""
    echo -e " ${GREEN}1.${PLAIN} 必应自签证书 ${YELLOW}（回车默认）${PLAIN}"
    echo -e " ${GREEN}2.${PLAIN} Acme 脚本自动申请（部分VPS不支持）"
...
menu() {
    ...
    echo -e "# ${GREEN}改动者${PLAIN}:  1118论坛魔改版                                    #"
    echo -e "# ${GREEN}原作者${PLAIN}:  Misaka                                           #"
    echo -e "# ${GREEN}GitHub 原项目${PLAIN}: https://github.com/Misaka-blog             #"
    echo -e "# ${GREEN}GitLab 本项目${PLAIN}: https://gitlab.com/Yzh666/                 #"
    echo -e "# ${GREEN}Telegram 频道${PLAIN}: telegram仅供捐助者加入                      #"
    echo -e "# ${GREEN}Telegram 群组${PLAIN}: 待定                                       #"
    echo -e "# ${GREEN}YouTube 频道${PLAIN}: https://www.youtube.ccom/@1118luntan        #"
    echo "#############################################################"
    echo ""
