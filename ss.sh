...
# Author: 1118luntan魔改<https://tizi.blog>
...
menu() {
    ...
    echo -e "  ${GREEN}2.${PLAIN}  更新Shadowsocks"
    echo -e "  ${GREEN}3.  ${RED}卸载Shadowsocks${PLAIN}"
    echo " -------------"
    echo -e "  ${GREEN}4.${PLAIN}  启动Shadowsocks"
    echo -e "  ${GREEN}5.${PLAIN}  重启Shadowsocks"
    echo -e "  ${GREEN}6.${PLAIN}  停止Shadowsocks"
    echo " -------------"
